...
F4A_data <- niche_data %>% filter(growthform == "tree"); range(F4A_data$lat_range_sd_g)
...
F4B_data <- niche_data %>% filter(growthform == "herb"); range(F4B_data$lat_range_sd_g)
...
F4C_data <- niche_data %>% filter(growthform == "tree"); range(F4C_data$lat_range_sd_g)
...
F4D_data <- niche_data %>% filter(growthform == "herb"); range(F4D_data$lat_range_sd_n)
