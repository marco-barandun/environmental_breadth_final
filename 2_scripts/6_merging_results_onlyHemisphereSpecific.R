...
only_southern_herbs <- southern_herbs %>%
  anti_join(., northern_herbs, by = "Species"); southern_herbs <- only_southern_herbs
only_northern_herbs <- northern_herbs %>%
  anti_join(., southern_herbs, by = "Species"); northern_herbs <- only_southern_herbs

only_southern_trees <- southern_trees %>%
  anti_join(., northern_trees, by = "Species"); southern_trees <- only_southern_trees
only_northern_trees <- northern_trees %>%
  anti_join(., southern_trees, by = "Species"); northern_trees <- only_northern_trees
